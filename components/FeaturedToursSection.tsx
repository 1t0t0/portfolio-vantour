...
import { toursData, Tour } from '@/data/featuredToursData';
          ...
          <div className="grid grid-cols-3 gap-4 h-[600px]">
            ...
            <div className="grid grid-rows-2 gap-4">
              ...
              <div 
                ...
                onClick={() => openModal(toursData[0])}
              >
                <div className="w-full h-full relative">
                  <Image
                    src={toursData[0].image}
                    alt={`${toursData[0].destination}, ${toursData[0].country}`}
                    fill
              ...
              <div 
                className="group cursor-pointer overflow-hidden rounded-xl relative transition-all duration-300 hover:shadow-2xl hover:scale-105"
                onClick={() => openModal(toursData[3])}
              >
                <div className="w-full h-full relative">
                  <Image
                    src={toursData[3].image}
                    alt={`${toursData[3].destination}, ${toursData[3].country}`}
                    fill
                    className="object-cover transition-transform duration-500 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-all duration-300"></div>
            ...
            <div className="grid grid-rows-3 gap-4">
              ...
              <div 
                ...
                onClick={() => openModal(toursData[1])}
              >
                <div className="w-full h-full relative">
                  <Image
                    src={toursData[1].image}
                    alt={`${toursData[1].destination}, ${toursData[1].country}`}
                    fill
                    className="object-cover transition-transform duration-500 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-all duration-300"></div>
              ...
              <div 
                className="group cursor-pointer overflow-hidden rounded-xl relative transition-all duration-300 hover:shadow-2xl hover:scale-105"
                onClick={() => openModal(toursData[4])}
              >
                <div className="w-full h-full relative">
                  <Image
                    src={toursData[4].image}
                    alt={`${toursData[4].destination}, ${toursData[4].country}`}
                    fill
                    className="object-cover transition-transform duration-500 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-all duration-300"></div>
            ...
            <div className="grid grid-rows-2 gap-4">
              ...
              <div 
                className="group cursor-pointer overflow-hidden rounded-xl relative transition-all duration-300 hover:shadow-2xl hover:scale-105"
                onClick={() => openModal(toursData[2])}
              >
                <div className="w-full h-full relative">
                  <Image
                    src={toursData[2].image}
                    alt={`${toursData[2].destination}, ${toursData[2].country}`}
                    fill
                    className="object-cover transition-transform duration-500 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-all duration-300"></div>
              ...
              <div 
                className="group cursor-pointer overflow-hidden rounded-xl relative transition-all duration-300 hover:shadow-2xl hover:scale-105"
                onClick={() => openModal(toursData[5])}
              >
                <div className="w-full h-full relative">
                  <Image
                    src={toursData[5].image}
                    alt={`${toursData[5].destination}, ${toursData[5].country}`}
                    fill
                    className="object-cover transition-transform duration-500 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-all duration-300"></div>
