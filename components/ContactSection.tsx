              ...
              >
                <div className="w-full h-full relative">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center">
                    ...
                    <div className="absolute bottom-4 right-4 bg-orange-400 text-white px-2 py-1 rounded text-xs">
              ...
              >
                <div className="w-full h-full relative">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center">
                    ...
                    <div className="absolute bottom-2 right-2 bg-orange-400 text-white px-2 py-1 rounded text-xs">
                      ดูเพิ่มเติม
                    </div>
                  </div>
                </div>
